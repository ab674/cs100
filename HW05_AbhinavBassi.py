...
def litCricFriend(wordList, text):
    ...
    newTextList = []
    for x in textList:
        newTextList.append(x.strip(string.punctuation))
    ...
    count = 0
    for i in wordList:
        count += newTextList.count(i.lower())
...
print('Frequency of \'a\' and \'an\' in The Bells = ' + str(litCricFriend(['a','an'], theBells)))
print('Frequency of \'a\' and \'an\' in  Canto XII = ' + str(litCricFriend(['a','an'], cantoXII)))
print('Frequency of \'the\' in The Bells = ' + str(litCricFriend(['the'], theBells)))
print('Frequency of \'the\' in Canto XII = ' + str(litCricFriend(['the'], cantoXII)))
...
'''
Yes, the results show that Poe and Neruda used 'a' and 'an' differently.
Poe's frequency was 0.035, whereas Neruda's was 0.010.
Yes, the results show that Poe and Neruda also used 'the' differently.
Poe's frequency was 0.136, whereas Neruda's was 0.054.
'''
